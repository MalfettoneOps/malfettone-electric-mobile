...
const styles = StyleSheet.create({
  ...
  dateLabel: { color: '#6B7280', fontSize: 13, marginTop: 2 },
  countBadge: {
  ...
  cardTitle: { color: '#111827', fontSize: 15, fontWeight: '600', marginBottom: 2 },
  cardCustomer: { color: '#6B7280', fontSize: 12 },
  badge: { borderRadius: 6, paddingHorizontal: 8, paddingVertical: 3, borderWidth: 1 },
  badgeText: { fontSize: 11, fontWeight: '600' },
  cardService: { color: '#374151', fontSize: 13, marginBottom: 4 },
  cardTime: { color: '#6B7280', fontSize: 12, marginBottom: 2 },
  cardPhone: { color: '#6B7280', fontSize: 12 },
  advanceBtn: {
    marginTop: 12, paddingTop: 12, borderTopWidth: 1, borderTopColor: '#F3F4F6',
    paddingVertical: 8, paddingHorizontal: 12, borderRadius: 8,
    backgroundColor: '#F9FAFB', borderWidth: 1, alignItems: 'center',
  },
  advanceBtnText: { fontSize: 13, fontWeight: '600' },
  empty: { alignItems: 'center', paddingTop: 80 },
  emptyEmoji: { fontSize: 48, marginBottom: 16 },
  emptyTitle: { color: '#111827', fontSize: 18, fontWeight: '600', marginBottom: 8 },
